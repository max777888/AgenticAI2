...
project_files = {
    "insurance_agent/requirements.txt": """langgraph
langchain_ollama
chromadb
langchain_core
""",
    "insurance_agent/policies.json": """{
    "POL-991": {"holder": "Sam", "coverage": 5000, "status": "Active", "deductible": 500},
    "POL-123": {"holder": "Alex", "coverage": 15000, "status": "Suspended", "deductible": 1000}
}""",
    "insurance_agent/claim_doc.txt": """CLAIM REPORT:
Policyholder Sam (POL-991) reported a minor fender bender at a grocery store parking lot. 
No injuries were reported. The claimant was driving at 5mph.
""",
...
print("✨ Project 'insurance_agent' created successfully!")